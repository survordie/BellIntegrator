...
VALUES (1, 0, 6, '56 00 112233', 'Петя', 'Петров', '', 2,'', '', true);

INSERT INTO User (id, version, office_id, doc_id, first_name, second_name, middle_name, position, phone, citizenship_code, is_identified)
VALUES (2, 0, 5, '56 01 112233', 'Вася', 'Васин', '', 3, '', '', true);

INSERT INTO User (id, version, office_id, doc_id, first_name, second_name, middle_name, position, phone, citizenship_code, is_identified)
VALUES (3, 0, 4, '56 02 112233', 'Сидор', 'Сидоров', '', 4,'', '', true);

INSERT INTO User (id, version, office_id, doc_id, first_name, second_name, middle_name, position, phone, citizenship_code, is_identified)
VALUES (4, 0, 3, '56 03 112233', 'Варвара', 'Орлова', '', 5,'', '', false);

INSERT INTO User (id, version, office_id, doc_id, first_name, second_name, middle_name, position, phone, citizenship_code, is_identified)
VALUES (5, 0, 2, '56 04 112233', 'Ваня', 'Иванов', '', 6,'', '', true);

INSERT INTO User (id, version, office_id, doc_id, first_name, second_name, middle_name, position, phone, citizenship_code, is_identified)
VALUES (6, 0, 1, '56 05 112233', 'Коля', 'Николаев', '', 7,'', '', true);

INSERT INTO Doc (id, version, doc_type_id, doc_number, doc_date)
VALUES (1, 0, '21' '56 00 112233', '1980-01-21');

INSERT INTO Doc (id, version, doc_type_id, doc_number, doc_date)
VALUES (2, 0, '21', '56 01 112233', '1982-01-21');

INSERT INTO Doc (id, version, doc_type_id, doc_number, doc_date)
VALUES (3, 0, '21', '56 02 112233', '1983-01-21');

INSERT INTO Doc (id, version, doc_type_id, doc_number, doc_date)
VALUES (4, 0, '21', '56 03 112233', '1984-01-21');

INSERT INTO Doc (id, version, doc_type_id, doc_number, doc_date)
VALUES (5, 0, '21', '56 04 112233', '1985-01-21');

INSERT INTO Doc (id, version, doc_type_id, doc_number, doc_date)
VALUES (6, 0, '21', '56 05 112233', '1986-01-21');
...
INSERT INTO Doc_Type (id, version, doc_id, code, name) VALUES (1, 0, '03', 'Свидетельство о рождении');
